...
### ------------------------------------------------------- ###
### running script sucessfully installs kokkos tools for gcc or intel
...
compilername=$2 # compile tools with "gcc" or "intel"
root4tools=$3 # absolute path for kokkos-tools installation
...
# example for for tools installed in /path/to/tools/kokkostools/ on linux:
