...
executables="constcoalcolls longcolls lowlistcolls straubcolls szakallurbichcolls testikstraubcolls"
...
script_args="${src_config_filename} --kernels constcoal long lowlist straub szakallurbich testikstraub \
