...
/* structure for opening files given
their filenames and copying their
contents line by line into a .txt file.
Useful for copying the details of a
model setup e.g. configuration and
values of constants */
