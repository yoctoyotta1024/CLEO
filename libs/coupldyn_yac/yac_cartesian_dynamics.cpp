...
CartesianDynamics::CartesianDynamics(const Config &config, const std::array<size_t, 3> i_ndims,
  ...
  yac_cdef_field("pressure", component_id, &cell_point_id, num_point_sets,
                 horizontal_fields_collection_size, "PT30M", YAC_TIME_UNIT_ISO_FORMAT,
                 &pressure_yac_id);
  ...
  yac_cdef_field("vertical_wind", component_id, &cell_point_id, num_point_sets,
                 vertical_winds_collection_size, "PT30M", YAC_TIME_UNIT_ISO_FORMAT,
                 &vertical_wind_yac_id);

  // --- Field coupling definitions ---
  yac_cdef_couple("atm", "icon_atmos_grid", "pressure", "cleo", "cleo_grid", "pressure", "PT30M",
  ...
  yac_cdef_couple("atm", "icon_atmos_grid", "temperature", "cleo", "cleo_grid", "temperature",
                  "PT30M", YAC_TIME_UNIT_ISO_FORMAT, YAC_REDUCTION_TIME_NONE, interp_stack_id, 0,
                  0);

  yac_cdef_couple("atm", "icon_atmos_grid", "qvap", "cleo", "cleo_grid", "qvap", "PT30M",
                  YAC_TIME_UNIT_ISO_FORMAT, YAC_REDUCTION_TIME_NONE, interp_stack_id, 0, 0);

  yac_cdef_couple("atm", "icon_atmos_grid", "qcond", "cleo", "cleo_grid", "qcond", "PT30M",
                  YAC_TIME_UNIT_ISO_FORMAT, YAC_REDUCTION_TIME_NONE, interp_stack_id, 0, 0);
