...
#ifndef LIBS_OBSERVERS2_WRITE_GRIDBOXES_DATA_HPP_
#define LIBS_OBSERVERS2_WRITE_GRIDBOXES_DATA_HPP_
...
class WriteGridboxesData {
 ...
 public:
  WriteGridboxesData(Dataset<Store> &dataset, GbxWriter writer)
      : dataset(dataset), writer(writer) {}

  ~WriteGridboxesData() { writer.write_arrayshape(dataset); }
...
#endif  // LIBS_OBSERVERS2_WRITE_GRIDBOXES_DATA_HPP_
