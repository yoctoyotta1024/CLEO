...
spack load cmake@3.23.1%gcc /zmoac3w

source activate /work/ka1298/k202167/condaenvs/cleoenv

base_path=/work/ka1298/k202167/remotes/cleo/new
path2CLEO=${base_path}/CLEO
path2build=${base_path}/CLEO/build
configfile=${path2CLEO}/examples/divfreemotion_yac/src/config/divfree2d_config.txt

python=/work/ka1298/k202167/condaenvs/cleoenv/bin/python
gxx="/sw/spack-levante/gcc-11.2.0-bcn7mb/bin/g++"
gcc="/sw/spack-levante/gcc-11.2.0-bcn7mb/bin/gcc"

YAC_C_INCLUDE_DIR=/work/ka1298/k202167/yac/src/mci/
YAC_C_LIBRARY=/work/ka1298/k202167/yac/src/libyac.a
...
kokkosdevice="-DKokkos_ENABLE_CUDA=OFF -DKokkos_ENABLE_CUDA_LAMBDA=O \
...
cmake -DCMAKE_CXX_COMPILER=${CXX} \
    ...
    -DYAC_C_LIBRARY=${YAC_C_LIBRARY} \
    -DYAC_C_INCLUDE_DIR=${YAC_C_INCLUDE_DIR} \
...
${python} ${path2CLEO}/examples/divfreemotion_yac/divfree2d.py \
