...
----- CLEO -----
File: yac_3d_fromfile.py
Project: yac_3d
Created Date: Thursday 30th May 2024
...
executable = path2build + "/examples/yac/fromfile/src/yac_3d"
...
savename = savefigpath + "yac_3d_maxnsupers_validation.png"
pltmoms.plot_totnsupers(time, maxnsupers, savename=savename)

nsample = 1000
savename = savefigpath + "yac_3d_motion2d_validation.png"
