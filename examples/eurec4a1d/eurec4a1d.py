...
updated_configfile['inputfiles'] = dict(
  ...
  grid_filename = str(path2build / 'share/eurec4a1d_ddimlessGBxboundaries.dat'),     # binary filename for initialisation of GBxs / GbxMaps
)
...
air_temperature_params = cloud_observation_config["thermodynamics"]["air_temperature"]["parameters"]
specific_humidity_params = cloud_observation_config["thermodynamics"]["specific_humidity"]["parameters"]
...
qcond       = 0.0                                                   # [Kg/Kg]
WVEL        = 0.0                                                   # [m/s]
Wlength     = 0                                                  # [m] use constant W (Wlength=0.0), or sinusoidal 1-D profile below cloud base
...
savefigpath = str(rawdirectory_individual / "figures") + "/" # directory for saving figures
