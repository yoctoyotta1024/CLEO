...
config_filename = path2build / "tmp" / "eurec4a1d_config.yaml"
thermofiles = sharepath / "eurec4a1d_dimlessthermo.dat"
config_params = {
    "constants_filename": str(path2CLEO / "libs" / "cleoconstants.hpp"),
    "grid_filename": str(sharepath / "eurec4a1d_dimlessGBxboundaries.dat"),
    "initsupers_filename": str(sharepath / "eurec4a1d_dimlessSDsinit.dat"),
    "setup_filename": str(binpath / "eurec4a1d_setup.txt"),
    "zarrbasedir": str(binpath / "eurec4a1d_sol.zarr"),
}
