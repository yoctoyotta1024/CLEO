...
private:
  ...
  satisfying the concept of a PairCoalescenceProbability) */
  {
    ...
    const int gamma = monte_carlo_gamma(gen, prob, eps1, eps2);
  ...
  int monte_carlo_gamma(std::mt19937 &gen, const double prob,
