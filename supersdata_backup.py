...
# # make time an indexer which corresponds to the unique values of the time attribute
...
# # make sdgbxindex an indexer which corresponds to the unique values of the sdgbxindex attribute
# # we can save this as gridbox index
# sddata.set_attribute(
...
bins = np.logspace(-7, 10, 20)

sddata.set_attribute(
    sddata["radius"].attribute_to_indexer_binned(bins=bins, new_name="radius_index")
)
...
# mass = sddata.attribute_to_DataArray("mass")
# xi = sddata.attribute_to_DataArray("xi")
# mass_represented_new = mass * xi
# sum_mass_1 = mass_represented_new.sum(dim="ragged_dimension_2")
sum_mass_2 = sddata.attribute_to_DataArray_reduction("mass_represented", ak.sum)
